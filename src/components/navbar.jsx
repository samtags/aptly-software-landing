...
export default function Navbar() {
  return (
    <div className="py-2 px-4 lg:mx-auto lg:max-w-[800px]">
      <nav className="bg-[#25272c] p-2 lg:pl-4 rounded-full flex items-center justify-between">
        ...
        <button className="bg-white rounded-full p-2 lg:hidden">
          <HiOutlineMenu fontSize={20} />
        </button>
        <button className="hidden lg:flex justify-center items-center gap-3 bg-white text-sm font-semibold p-2 md:pl-4 rounded-full border border-[#d2dae4] text-[#323745]">
          Book a Call
