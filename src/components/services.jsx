...
export default function Services() {
  return (
    <section
      className="px-5 pt-13 max-w-[1100px] mx-auto "
      data-aos="fade-up"
    ...
    >
      ...
      <div className="bg-[#f9fafb] rounded-[48px] p-5 mt-12 flex flex-col gap-5 md:grid md:grid-cols-2 lg:grid-cols-3">
        <div
          className="bg-white rounded-[32px] p-7 pb-0 service-card-shadow flex flex-col justify-between md:order-[2] lg:order-[1] lg:row-span-2"
          data-aos="fade-up"
        ...
        <div
          className="bg-white rounded-[32px] p-7 service-card-shadow md:order-[1] lg:order-[2] md:col-span-full lg:col-span-2 lg:row-span-1"
          data-aos="fade-up"
        ...
        <div
          className="bg-white rounded-[32px] p-7 service-card-shadow flex flex-col lg:flex-row gap-12 md:order-[3] lg:col-span-2 lg:row-span-1"
          data-aos="fade-up"
        ...
        <div
          className="bg-white rounded-[32px] p-7 pb-0 service-card-shadow md:order-[4] md:col-span-full lg:col-span-2"
          data-aos="fade-up"
        ...
        <div
          className="p-6 bg-[#151619] rounded-[32px] h-[230px] md:h-auto flex flex-col justify-end service-accent relative overflow-hidden md:order-[5] md:col-span-full lg:col-span-1"
          data-aos="fade-up"
        ...
        >
          <div className="text-xl lg:text-2xl">
            ...
            <Link target="blank" href="/contact">
              <button className="cursor-pointer inline-flex justify-center items-center gap-3 bg-white text-sm font-medium pl-4 py-1 pr-1 rounded-full border border-[#d2dae4] text-[#323745] mt-5">
                Book call now
                <div className="bg-[#f3f5f6] p-2 rounded-full">
                  <HiArrowUpRight strokeWidth={1} fontSize={12} />
                </div>
