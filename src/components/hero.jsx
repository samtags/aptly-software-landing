...
export default function Hero() {
  return (
    <section className="hero">
      ...
      <h1 className="text-[32px] font-bold leading-10 text-center px-12 mb-6 tracking-tight">
        Modern problems require modern solutions
      </h1>
      <p className="px-4 text-center text-sm font-medium text-[#323745] mb-9">
        We design, build, and operate modern applications that solve real-world
        problems for businesses and consumers.
      </p>
      <div className="flex flex-col px-4 gap-3">
        <button className="flex justify-center items-center gap-3 bg-[#151619] text-white text-sm font-medium p-4 py-[10px] rounded-full">
          <div className="bg-[#ffffff21] p-2 rounded-full">
            <IoCallOutline width={2} fontSize={14} />
          </div>
          Book an intro call
        </button>
        <button className="flex justify-center items-center gap-3 bg-white text-sm font-medium p-4 py-[10px] rounded-full border border-[#d2dae4] text-[#323745]">
          View Pricing
